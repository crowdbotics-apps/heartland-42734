"""
Django settings for late_waterfall_42734 project.
...
ROOT_URLCONF = 'late_waterfall_42734.urls'
...
WSGI_APPLICATION = 'late_waterfall_42734.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_waterfall_42734 API",
    "DESCRIPTION": "API documentation for late_waterfall_42734 App",
    "VERSION": "v1",
}
